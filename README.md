> :zap: :checkered_flag:  **_Deepdrive 3.0 with support for Mobile Net 2, reinforcement learning via PPO2, Docker and more is almost ready! Check out the pre-release in the [v3 branch](https://github.com/deepdrive/deepdrive-sim/tree/v3)._**
