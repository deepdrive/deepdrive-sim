...
DECLARE_LOG_CATEGORY_EXTERN(LogSharedMemoryImpl_Mac, Log, All);
#endif

class SharedMemoryImpl_Mac : public ISharedMemoryImpl {
...
public:
    ...
    SharedMemoryImpl_Mac();

    virtual ~SharedMemoryImpl_Mac();
