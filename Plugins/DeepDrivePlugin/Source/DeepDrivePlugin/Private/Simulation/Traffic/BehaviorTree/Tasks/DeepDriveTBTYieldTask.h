...
DECLARE_LOG_CATEGORY_EXTERN(LogDeepDriveTBTYieldTask, Log, All);

class DeepDriveTBTYieldTask : public DeepDriveTBTTaskBase
{
public:

	DeepDriveTBTYieldTask();
...
private:
	...
	int32			m_LineOfSightLocationIndex = -1;
